...
if ($products->have_posts()) :
    ...
    <div class="upsells products">
        ...
        <div class="owl-carousel posts-list related-product" data-width="<?php print $size['width']; ?>" data-height="<?php print $size['height']; ?>" data-margin="<?php print $options['upsells_products_carousel_margin']; ?>">
