        ...
        <div id="content" class="site-content" role="main">
            ...
            <div class="page-wrapper">
                <div class="page-content">
                    <h2><?php esc_html_e('This is somewhat embarrassing, isn&rsquo;t it?', 'sport-ak'); ?></h2>
                    <p><?php esc_html_e('It looks like nothing was found at this location.', 'sport-ak'); ?></p>
                </div><!-- .page-content -->
            </div><!-- .page-wrapper -->
