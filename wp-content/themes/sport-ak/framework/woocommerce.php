...
$azexo_woo_templates = array(
    'single_product' => esc_html__('Single product', 'sport-ak'), //default template
    'shop_product' => esc_html__('Shop product', 'sport-ak'), //default template
    'detailed_shop_product' => esc_html__('Detailed shop product', 'sport-ak'), //fixed in shop modes
    'related_product' => esc_html__('Related product', 'sport-ak'), //fixed in related template
    'upsells_product' => esc_html__('Up-sells product', 'sport-ak'), //fixed in up-sells template
);
...
$azexo_woo_fields = array(
    'purchased' => esc_html__('Product purchased', 'sport-ak'),
    'discount' => esc_html__('Product discount', 'sport-ak'),
    'sale_time_left' => esc_html__('Product sale time left', 'sport-ak'),
    'availability' => esc_html__('Product availability', 'sport-ak'),
    'last_review_rating' => esc_html__('Product last review rating', 'sport-ak'),
    'loop_sale_flash' => esc_html__('Loop product sale flash', 'sport-ak'),
    'loop_rating' => esc_html__('Loop product average rating', 'sport-ak'),
    'loop_price' => esc_html__('Loop product price', 'sport-ak'),
    'loop_add_to_cart' => esc_html__('Loop product add to cart link', 'sport-ak'),
    'product_thumbnail' => esc_html__('Product thumbnail', 'sport-ak'),
    'product_gallery' => esc_html__('Product gallery', 'sport-ak'),
    'single_sale_flash' => esc_html__('Single product sale flash', 'sport-ak'),
    'single_add_to_cart' => esc_html__('Single product add to cart', 'sport-ak'),
    'single_rating' => esc_html__('Single product average rating', 'sport-ak'),
    'single_price' => esc_html__('Single product price', 'sport-ak'),
    'single_meta' => esc_html__('Single product meta', 'sport-ak'),
    'single_sharing' => esc_html__('Single product sharing', 'sport-ak'),
    'single_data_tabs' => esc_html__('Single data tabs', 'sport-ak'),
    'single_related_products' => esc_html__('Single related products', 'sport-ak'),
    'single_upsell_display' => esc_html__('Single upsell display', 'sport-ak'),
    'single_description' => esc_html__('Single description', 'sport-ak'),
    'single_reviews' => esc_html__('Single reviews', 'sport-ak'),
    'single_additional_information' => esc_html__('Single additional information', 'sport-ak'),
);

if (class_exists('WCV_Vendor_Shop')) {
    $azexo_fields['loop_sold_by'] = esc_html__('Loop product sold by', 'sport-ak');
}
if (class_exists('YITH_WCWL_Shortcode')) {
    $azexo_fields['add_to_wishlist'] = esc_html__('Add product to wishlist', 'sport-ak');
}
if (class_exists('YITH_WCQV_Frontend')) {
    $azexo_fields['quick_view'] = esc_html__('Product quick view', 'sport-ak');
}
...
function azexo_woo_settings_sections($sections) {
    ...
    $sections[] = array(
        'icon' => 'el-icon-cogs',
        'title' => esc_html__('WooCommerce templates configuration', 'sport-ak'),
        'fields' => array(
            array(
                'id' => 'shop_title',
                'type' => 'text',
                'title' => esc_html__('Shop page title', 'sport-ak'),
                'default' => 'Shop',
            ),
            array(
                'id' => 'product_label',
                'type' => 'text',
                'title' => esc_html__('Alter "Product" labels', 'sport-ak'),
                'default' => 'Product',
            ),
            array(
                'id' => 'products_label',
                'type' => 'text',
                'title' => esc_html__('Alter "Products" labels', 'sport-ak'),
                'default' => 'Products',
            ),
            array(
                'id' => 'review_form_placeholders',
                'type' => 'checkbox',
                'title' => esc_html__('Use placeholders in review form', 'sport-ak'),
                'default' => '0',
            ),
            array(
                'id' => 'custom_sorting',
                ...
                'multi' => true,
                'sortable' => true,
                'title' => esc_html__('Custom sorting', 'sport-ak'),
                'options' => array(
                    'menu_order' => esc_html__('Default sorting', 'sport-ak'),
                    'popularity' => esc_html__('Sort by popularity', 'sport-ak'),
                    'rating' => esc_html__('Sort by average rating', 'sport-ak'),
                    'date' => esc_html__('Sort by newness', 'sport-ak'),
                    'price' => esc_html__('Sort by price: low to high', 'sport-ak'),
                    'price-desc' => esc_html__('Sort by price: high to low', 'sport-ak'),
                ),
            ...
            array(
                ...
                'type' => 'multi_text',
                'title' => esc_html__('Custom sorting numeric meta keys', 'sport-ak'),
            ),
            array(
                'id' => 'shop_modes',
                'type' => 'checkbox',
                'title' => esc_html__('Show shop modes', 'sport-ak'),
                'default' => '0',
            ),
            array(
                'id' => 'show_data_tabs',
                'type' => 'checkbox',
                'title' => esc_html__('Show data tabs', 'sport-ak'),
                'default' => '1',
            ),
            array(
                'id' => 'show_related_products',
                'type' => 'checkbox',
                'title' => esc_html__('Show related products', 'sport-ak'),
                'default' => '1',
            ),
            array(
                'id' => 'show_upsells_products',
                'type' => 'checkbox',
                'title' => esc_html__('Show upsells products', 'sport-ak'),
                'default' => '1',
            ),
            array(
                'id' => 'upsells_products_carousel_margin',
                'type' => 'text',
                'title' => esc_html__('Up-sells products carousel margin', 'sport-ak'),
                'default' => '0',
            ),
            array(
                'id' => 'related_products_carousel_margin',
                'type' => 'text',
                'title' => esc_html__('Related products carousel margin', 'sport-ak'),
                'default' => '0',
            ),
            array(
                'id' => 'show_ratings_summary',
                'type' => 'checkbox',
                'title' => esc_html__('Show ratings summary', 'sport-ak'),
                'default' => '0',
            ),
            array(
                'id' => 'review_marks',
                'type' => 'multi_text',
                'title' => esc_html__('Review marks', 'sport-ak'),
            ),
            array(
                'id' => 'review_likes',
                'type' => 'checkbox',
                'title' => esc_html__('Review likes', 'sport-ak'),
                'default' => '0',
            ),
        )
    );
...
function azexo_woo_taxonomy_args_product_cat($args) {
    if (!is_admin()) {
        ...
        if (isset($options['product_label']) && !empty($options['product_label'])) {
            $args['label'] = $options['product_label'] . ' ' . esc_html__('Categories', 'sport-ak');
            $args['labels']['name'] = $options['product_label'] . ' ' . esc_html__('Categories', 'sport-ak');
            $args['labels']['singular_name'] = $options['product_label'] . ' ' . esc_html__('Category', 'sport-ak');
        }
    }
    return $args;
}
...
function azexo_woo_taxonomy_args_product_tag($args) {
    if (!is_admin()) {
        $options = get_option(AZEXO_FRAMEWORK);
        if (isset($options['product_label']) && !empty($options['product_label'])) {
            $args['label'] = $options['product_label'] . ' ' . esc_html__('Tags', 'sport-ak');
            $args['labels']['name'] = $options['product_label'] . ' ' . esc_html__('Tags', 'sport-ak');
            $args['labels']['singular_name'] = $options['product_label'] . ' ' . esc_html__('Tag', 'sport-ak');
        }
    }
    return $args;
}
...
function azexo_woo_pre_get_posts($query) {
    if ($query->is_main_query() && is_user_logged_in() && azexo_is_post_type_query($query, 'product')) {
        if ($query->get('author') == get_current_user_id()) {
            ...
            if (is_array($meta_query)) {
                foreach ($meta_query as $key => $mq) {
                    if (isset($mq['key']) && $mq['key'] == '_visibility') {
    ...
    if (!is_user_logged_in()) {
        foreach ($sorted_menu_items as $i => &$menu_item) {
            if ($menu_item->object_id == $woocommerce_myaccount_page_id && $menu_item->object == 'page') {
                $menu_item->title = esc_html__('Login/Register', 'sport-ak');
            }
        }
    }
    $remove_array = array();
...
function azexo_woo_menu_start_el($item, $args) {
    ...
    if (is_array($item->classes)) {
        if (in_array('hot', $item->classes)) {
            ...
            $item->additions .= '<span class="hot">' . esc_html__('Hot', 'sport-ak') . '</span>';
        }
        if (in_array('new', $item->classes)) {
            $item->classes = array_diff($item->classes, array('new'));
            $item->additions .= '<span class="new">' . esc_html__('New', 'sport-ak') . '</span>';
        }
    }
    return $item;
}
...
azexo_add_element(array(
    ...
    'category' => esc_html__('WooCommerce', 'sport-ak'),
...
azexo_add_element(array(
    'name' => esc_html__('Cart widget', 'sport-ak'),
    'base' => 'woocommerce_cart_widget',
    'icon' => 'icon-wpb-woocommerce',
    'category' => esc_html__('WooCommerce', 'sport-ak'),
    'description' => esc_html__('Displays the cart contents', 'sport-ak'),
    'show_settings_on_create' => false,
    'params' => array(
        array(
            'type' => 'textfield',
            ...
            'value' => esc_html__('Cart', 'sport-ak'),
        ),
        array(
            'type' => 'checkbox',
            'heading' => esc_html__('Hide if cart is empty', 'sport-ak'),
            'param_name' => 'hide_if_empty',
            'value' => array(
                esc_html__('Yes, please', 'sport-ak') => 1,
            ),
        ),
        array(
            'type' => 'textfield',
...
function azexo_woo_catalog_orderby($sortby) {
    ...
    if (isset($options['custom_sorting_numeric_meta_keys']) && is_array($options['custom_sorting_numeric_meta_keys'])) {
        foreach ($options['custom_sorting_numeric_meta_keys'] as $meta_key) {
            if (!empty($meta_key)) {
                $sortby[esc_attr($meta_key) . '-desc'] = sprintf(esc_attr__('Sort by %s: high to low', 'sport-ak'), esc_attr($meta_key));
                $sortby[esc_attr($meta_key) . '-asc'] = sprintf(esc_attr__('Sort by %s: low to high', 'sport-ak'), esc_attr($meta_key));
            }
        }
    }
    return $sortby;
