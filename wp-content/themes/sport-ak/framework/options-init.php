    ...
    class AZEXO_Redux_Framework {
        ...
        public function setSections() {
            ...
            $azexo_templates = array_merge($azexo_templates, array(
                ...
                'navigation_post' => esc_html__('Navigation post', 'sport-ak'), //fixed in full post navigation
            ...
            $azexo_post_fields = array(
                ...
                'post_last_comment_author_avatar' => esc_html__('Post last comment author avatar', 'sport-ak'),
            ...
            foreach ($taxonomies as $slug => $taxonomy) {
                $taxonomy_fields['taxonomy_' . $slug] = esc_html__('Taxonomy: ', 'sport-ak') . $taxonomy->label;
            }
            ...
            if (is_array($azh_widgets)) {
                foreach ($azh_widgets as $azh_widget) {
                    $azexo_fields[$azh_widget->ID] = $azh_widget->post_title . ' ' . esc_html__('AZH Widget', 'sport-ak');
                }
            }
            ...
            $general_settings_fields[] = array(
                ...
                'type' => 'select',
                'title' => esc_html__('Single blog template', 'sport-ak'),
            ...
            $general_settings_fields[] = array(
                ...
                'mode' => 'javascript',
                'theme' => 'chrome', $general_settings_fields[] = 'default' => "jQuery(document).ready(function(){\n\n});"
            );
            ...
            $general_settings_fields[] = array(
                ...
                'multi' => true,
                'sortable' => true,
                'title' => esc_html__('Custom dashboard pages', 'sport-ak'),
                'options' => $pages_options,
            );


            $skins = function_exists('azexo_get_skins') ? azexo_get_skins() : array(get_template());
                ...
                foreach ($post_types as $slug => $post_type) {
                    $fields = array(
                        array(
                            ...
                            'type' => 'select',
                            'title' => esc_html__('Single template', 'sport-ak'),
                            'options' => $azexo_templates,
                            'default' => $slug,
                        ),
                        array(
                            ...
                            'type' => 'select',
                            'title' => esc_html__('Default template', 'sport-ak'),
                            'options' => $azexo_templates,
                            'default' => $slug,
                        ),
                        array(
                        ...
                        array(
                            ...
                            'type' => 'select',
                            'multi' => true,
                            'title' => esc_html__('Show additional sidebar', 'sport-ak'),
                            'options' => array(
                                'single' => esc_html__('Single page', 'sport-ak'),
                                'list' => esc_html__('List page', 'sport-ak'),
                            ),
                            'default' => '',
                        ),
                    );
                    if ($slug != 'product') {
                        $fields = array_merge($fields, array(array(
                                ...
                                'multi' => true,
                                'sortable' => true,
                                'title' => esc_html__('Before posts list', 'sport-ak'),
                                'options' => array(
                                    'result_count' => esc_html__('Result count', 'sport-ak'),
                                    'ordering' => esc_html__('Ordering', 'sport-ak'),
                                ),
                                'default' => array(),
                            ),
                            array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'checkbox',
                        'title' => esc_html__('Header parts fullwidth', 'sport-ak'),
                        'default' => '0'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'type' => 'checkbox',
                        'title' => esc_html__('Content fullwidth', 'sport-ak'),
                        'default' => '0'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'type' => 'checkbox',
                        'title' => esc_html__('Post navigation full template', 'sport-ak'),
                        'default' => '0'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'type' => 'select',
                        'title' => esc_html__('Before posts place', 'sport-ak'),
                        'options' => array(
                            'inside_content_area' => esc_html__('Inside content area', 'sport-ak'),
                            'before_container' => esc_html__('Before container', 'sport-ak'),
                        ),
            ...
            foreach ($azexo_templates as $template_slug => $template_name) {
                ...
                $places = array(
                    ...
                    $template_slug . '_next' => esc_html__('Append next', 'sport-ak'),
                );
                $post_fields = array();
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array_merge(array(
                        array(
                            ...
                            'type' => 'checkbox',
                            'title' => esc_html__('Show thumbnail/gallery/video', 'sport-ak'),
                            'default' => '1'
                        ),
                        array(
                            'id' => $template_slug . '_image_thumbnail',
                            'type' => 'checkbox',
                            'title' => esc_html__('Only image thumbnail (no gallery/video)', 'sport-ak'),
                            'default' => '0',
            ...
            $theme_info .= '<p class="redux-framework-theme-data description theme-uri">' . wp_kses(__('<strong>Theme URL:</strong> ', 'sport-ak'), array('strong' => array())) . '<a href="' . esc_url($this->theme->get('ThemeURI')) . '" target="_blank">' . $this->theme->get('ThemeURI') . '</a></p>';
            $theme_info .= '<p class="redux-framework-theme-data description theme-author">' . wp_kses(__('<strong>Author:</strong> ', 'sport-ak'), array('strong' => array())) . $this->theme->get('Author') . '</p>';
            $theme_info .= '<p class="redux-framework-theme-data description theme-version">' . wp_kses(__('<strong>Version:</strong> ', 'sport-ak'), array('strong' => array())) . $this->theme->get('Version') . '</p>';
            $theme_info .= '<p class="redux-framework-theme-data description theme-description">' . $this->theme->get('Description') . '</p>';
            $tabs = $this->theme->get('Tags');
            if (!empty($tabs)) {
                $theme_info .= '<p class="redux-framework-theme-data description theme-tags">' . wp_kses(__('<strong>Tags:</strong> ', 'sport-ak'), array('strong' => array())) . implode(', ', $tabs) . '</p>';
            }
            $theme_info .= '</div>';
