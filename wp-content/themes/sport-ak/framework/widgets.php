...
class AZEXO_Post extends WP_Widget {
    ...
    function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'sport-ak'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
        </p><p>            
            <label for="<?php echo esc_attr($this->get_field_id('post')); ?>"><?php esc_html_e('Post ID:', 'sport-ak'); ?></label>
        ...
        <p>    
            ...
            <label for="<?php echo esc_attr($this->get_field_id('full')); ?>"><?php esc_html_e('Full post', 'sport-ak'); ?></label>
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('template')); ?>"><?php esc_html_e('Post template:', 'sport-ak'); ?></label>
...
class AZEXO_Taxonomy extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array('classname' => 'widget_categories', 'description' => esc_html__("A list or dropdown of categories.", 'sport-ak'));
    ...
    public function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Categories', 'sport-ak') : $instance['title'], $instance, $this->id_base);
        ...
        if ($d) {
            ...
            $cat_args['show_option_none'] = esc_html__('Please select', 'sport-ak');
    ...
    public function form($instance) {
        ...
        ?>
        <p><label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'sport-ak'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id('taxonomy')); ?>"><?php esc_html_e('Taxonomy:', 'sport-ak'); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('dropdown')); ?>"><?php esc_html_e('Display as dropdown', 'sport-ak'); ?></label><br />

            <input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id('count')); ?>" name="<?php echo esc_attr($this->get_field_name('count')); ?>"<?php checked($count); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('count')); ?>"><?php esc_html_e('Show post counts', 'sport-ak'); ?></label><br />

            <input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id('hierarchical')); ?>" name="<?php echo esc_attr($this->get_field_name('hierarchical')); ?>"<?php checked($hierarchical); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('hierarchical')); ?>"><?php esc_html_e('Show hierarchy', 'sport-ak'); ?></label>
        </p>
        <?php
    }
...
class AZEXO_Dashboard_Links extends WP_Widget {
    ...
    public function form($instance) {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('visible_if_active')); ?>"><?php esc_html_e('Visible if have active link', 'sport-ak'); ?></label><br />
        </p>
        <?php
    }
...
$azexo_widgets_visibility = array(
    'show_on_dashboard' => esc_html__('Show only on dashboard', 'sport-ak'),
    'hide_on_dashboard' => esc_html__('Hide on dashboard', 'sport-ak'),
    'show_on_profiles_list' => esc_html__('Show only on profiles list', 'sport-ak'),
    'hide_on_profiles_list' => esc_html__('Hide on profiles list', 'sport-ak'),
    'show_on_shop' => esc_html__('Show only on shop', 'sport-ak'),
    'hide_on_shop' => esc_html__('Hide on shop', 'sport-ak'),
);
...
function azexo_filter_widget($instance, $wp_widget) {
    if ($instance) {
        ...
        if (isset($instance['show_on_profiles_list']) && $instance['show_on_profiles_list']) {
            if (basename(get_page_template()) != 'profiles.php' && basename(get_page_template()) != 'vendors-profiles.php') {
                return false;
            }
        }
