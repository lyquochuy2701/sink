...
<?php if (!empty($coupon)) : ?>
    <div class="coupon-wrapper">
        <a href="<?php print (!empty($product_url) ? esc_url($product_url) : '#'); ?>" target="_blank" data-code="<?php print esc_attr($coupon); ?>" class="coupon" data-copied="<?php esc_attr_e('Code copied to the clipboard', 'sport-ak'); ?>"><?php esc_attr_e('Show code', 'sport-ak'); ?></a>
    </div>
<?php endif; ?>
