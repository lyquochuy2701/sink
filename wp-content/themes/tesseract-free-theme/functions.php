...
class new_tes_general_setting {
    function new_tes_general_setting( ) {
...
function tes_designer_content_block_reset(){
	if(update_option( 'tesseract_doing_import', 0 )){
		...
		echo "<span style='color: black; font-family: Times New Roman; font-size: 18px; font-style: italic; border-bottom: 0.5px solid red; border-color: red;'>Problem Occurs. Please <b>Refresh</b> The Page and Try Again.</span>";
	}
	exit;
